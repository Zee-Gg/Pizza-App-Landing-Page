        ...
        <nav className="container py-5 flex items-center justify-between">
            <div className="flex items-center space-x-4">
                <svg
                    ...
                    <SelectContent>
                    <SelectItem value="cheezious">Cheezious</SelectItem>
            ...
            <div className="flex items-center space-x-4 gap-4">
                <ul className="flex items-center font-medium space-x-4">
                    <li><Link className="hover:text-orange-400" href={'/'}>Menu</Link>
                    </li>

                     <li><Link className="hover:text-orange-400" href={'/'}>Orders</Link>
                    </li>
                </ul>
                <div className="relative">
                    <Link href="/cart"><ShoppingBag /></Link>
                    <span className="absolute -top-4 -right-5 h-6 w-6 flex items-center justify-center rounded-full bg-orange-400 font-bold text-white">3</span>
                </div>

                <div className="flex items-center gap-x-2 ml-12">
                    <Phone/>
                    <span>+92 3346814888</span>
